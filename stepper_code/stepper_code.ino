...
// Park position — commanded positive on both axes so the arm physically
// moves to negative X and negative Y (below-left of home, off the paper
// and clear of the camera frame).
